...
from app.commands import MILESTONES, build_brag_url, highest_milestone


# --- highest_milestone ------------------------------------------------------

def test_milestones_constant():
    assert MILESTONES == (10, 25, 50, 100)
...
def test_highest_milestone_boundaries():
    ...
    assert highest_milestone(24) == 10
    assert highest_milestone(25) == 25
    assert highest_milestone(49) == 25
    assert highest_milestone(50) == 50
    assert highest_milestone(99) == 50
    assert highest_milestone(100) == 100
    assert highest_milestone(250) == 100
