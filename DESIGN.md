...
최종 갱신: 2026-06-24 (히어로 거리 크롭읽기 · 운동시간 날짜오염 수정 · 런데이 2단 칼로리)
...
- 전처리(가벼움): 흑백+autocontrast(A), **밝은 글씨 이진화**(B, 사진 위 흰 글씨), **원본 컬러**(C, 분홍 칼로리 등), **상단 45% 크롭+확대+이진화**(D, 삼성헬스 큰 거리 히어로). 각 변형 PSM 6/11 후 텍스트 합쳐 파싱.
